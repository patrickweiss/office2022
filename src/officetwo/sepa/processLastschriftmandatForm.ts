import { LastschriftmandatTableCache } from "../../officeone/BusinessDataFacade";

const httpEndpoint = "https://script.google.com/macros/s/AKfycbzofWRoZOPDdS8IUMVkAOv4W_TJICjpzpm--PCwZUPUdWHEKxc/exec"
export const processLastschriftmandatForm = (event:GoogleAppsScript.Events.SheetsOnFormSubmit,rootId:string) => {
