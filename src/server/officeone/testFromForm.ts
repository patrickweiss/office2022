...
function eMailMitLink(kundenEmail, kundenName, e) {
    ...
    try {
        ...
        var neueVersionString = currentOOversion;
        let clientFolder = DriveApp.getFolderById("0Bww6H6AlfkCfT0Vnc281SU1YR28")
            .createFolder("XXXX " + kundenEmail + ".Office " + currentOOversion);
        let bm = new BusinessModel(clientFolder.getId(),"eMailMitLink");
        clientFolder.setName(bm.endOfYear().getFullYear() + " " + kundenEmail + ".Office " + currentOOversion);
